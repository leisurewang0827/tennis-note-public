...
const BUDGET = [
  // 1.0.405 병합분. 다음 커밋에서 정리한다.
  { app: "app/admin", label: "관리자", budget: 26 },
  // 1.0.405 병합분. 다음 커밋에서 정리한다.
  { app: "app/tennis-note-member-app", label: "회원앱", budget: 52 },
  // 1.0.405 병합분. 다음 커밋에서 정리한다.
  { app: "app/tennis-note-coach-app", label: "코치앱", budget: 31 },
];
