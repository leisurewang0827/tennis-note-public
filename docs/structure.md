...
| | 회원앱 | 코치앱 | 관리자 |
|---|---|---|---|
| `domain` | 18개 5,034줄 | 15개 2,536줄 | 11개 8,938줄 |
| `views` | 10개 2,810줄 | 8개 1,411줄 | 11개 6,380줄 |
| `actions` | 7개 1,827줄 | 4개 1,081줄 | 8개 7,266줄 |
| `forms` | 6개 1,005줄 | 2개 305줄 | 6개 2,855줄 |
| `data` | 7개 2,096줄 | 4개 1,227줄 | 5개 1,898줄 |
| `events` | 7개 861줄 | 2개 623줄 | 9개 2,554줄 |
| `ui` | 3개 818줄 | 3개 441줄 | 5개 1,306줄 |
| `catalog.js` | 411줄 | 55줄 | 806줄 |
| `storage.js` | 409줄 | 196줄 | 297줄 |
| `settings.js` | 64줄 | 47줄 | 127줄 |
| **`app.js`** | **1,119줄** | **619줄** | **1,326줄** |
