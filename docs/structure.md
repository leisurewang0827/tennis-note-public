...
| | 회원앱 | 코치앱 | 관리자 |
|---|---|---|---|
| `domain` | 18개 5,005줄 | 15개 2,516줄 | 11개 8,850줄 |
| `views` | 10개 2,810줄 | 8개 1,411줄 | 11개 6,370줄 |
| `actions` | 7개 1,808줄 | 4개 1,081줄 | 8개 7,301줄 |
| `forms` | 6개 944줄 | 2개 305줄 | 6개 2,824줄 |
| `data` | 7개 1,982줄 | 4개 1,226줄 | 5개 1,858줄 |
| `events` | 7개 855줄 | 2개 623줄 | 9개 2,552줄 |
