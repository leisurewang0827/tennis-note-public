...
| | 회원앱 | 코치앱 | 관리자 |
|---|---|---|---|
| `domain/` | 17개 4,820줄 | 15개 2,528줄 | 11개 8,702줄 |
| `views/` | 9개 2,631줄 | 8개 1,380줄 | 11개 6,330줄 |
| `actions/` | 6개 1,595줄 | 4개 1,073줄 | 8개 7,290줄 |
| `forms/` | 6개 957줄 | 2개 303줄 | 6개 2,815줄 |
| `data/` | 5개 1,745줄 | 4개 1,216줄 | 5개 1,826줄 |
| `events/` | 7개 846줄 | 2개 553줄 | 9개 2,551줄 |
| `ui/` | 3개 799줄 | 3개 432줄 | 5개 1,260줄 |
| `catalog.js` | 410줄 | 55줄 | 806줄 |
| `storage.js` | 335줄 | 196줄 | 297줄 |
| `settings.js` | 61줄 | 47줄 | 127줄 |
| **`app.js`** | **972줄** | **240줄** | **1,115줄** |
