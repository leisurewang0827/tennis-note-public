...
| | 회원앱 | 코치앱 | 관리자 |
|---|---|---|---|
| `domain/` | 18개 5,034줄 | 15개 2,536줄 | 11개 9,011줄 |
| `views/` | 10개 2,810줄 | 8개 1,411줄 | 11개 6,396줄 |
| `actions/` | 7개 1,827줄 | 4개 1,081줄 | 8개 7,277줄 |
| `forms/` | 6개 1,005줄 | 2개 305줄 | 6개 2,858줄 |
| `data/` | 7개 2,096줄 | 4개 1,227줄 | 5개 1,898줄 |
| `events/` | 7개 861줄 | 2개 623줄 | 9개 2,566줄 |
| `ui/` | 3개 818줄 | 3개 441줄 | 5개 1,306줄 |
| `catalog.js` | 411줄 | 55줄 | 807줄 |
| `storage.js` | 409줄 | 196줄 | 297줄 |
| `settings.js` | 64줄 | 47줄 | 127줄 |
| **`app.js`** | **1,119줄** | **619줄** | **1,327줄** |

시작할 때는 각각 14,218 · 7,998 · 31,096줄이었습니다.

⚠ **위 숫자는 이 문서를 쓴 시점 값입니다.** 갱신은 손으로 하지 말고
`./scripts/update_structure_sizes.py` 를 돌리세요. 손으로 하다 아래
"폴더가 뜻하는 것" 표까지 덮어쓴 사고가 있었습니다.
