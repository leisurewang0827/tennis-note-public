const CACHE_NAME = "tennis-note-coach-mode-v455";
...
const APP_SHELL = [
  ...
  "./domain/records.js?v=1.0.433",
  "./domain/members.js?v=1.0.433",
  "./domain/schedule-v2.js?v=1.0.433",
  "./domain/notices.js?v=1.0.433",
  "./domain/curriculum.js?v=1.0.433",
  "./domain/settlement.js?v=1.0.433",
  "./domain/makeup.js?v=1.0.433",
  "./domain/shared-data.js?v=1.0.433",
  "./domain/tasks.js?v=1.0.433",
  "./views/home.js?v=1.0.433",
  "./views/schedule.js?v=1.0.433",
  "./views/members.js?v=1.0.433",
  "./views/records.js?v=1.0.433",
  "./views/curriculum.js?v=1.0.433",
  "./views/settlement.js?v=1.0.433",
  ...
  "./data/records.js?v=1.0.433",
  "./ui/sheet.js?v=1.0.433",
  "./ui/screens.js?v=1.0.433",
  "./actions/records.js?v=1.0.433",
  "./actions/schedule.js?v=1.0.433",
  ...
  "../shared/tennisnote-curriculum-search.js?v=1.0.433",
  ...
  "../shared/tennisnote-comment-draft.js?v=1.0.433",
