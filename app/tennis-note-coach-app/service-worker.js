const CACHE_NAME = "tennis-note-coach-mode-v430";
const CACHE_PREFIX = "tennis-note-coach-mode-";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=1.0.408",
  "./app.js?v=1.0.408",
  "./assets/app-icon.svg",
  "../release.json",
  "../shared/tennisnote-data-client.js?v=1.0.408",
  "../shared/tennisnote-schedule-revision.js?v=1.0.408",
  "../shared/tennisnote-schedule-lanes.js?v=1.0.408",
  "../shared/tennisnote-curriculum-catalog.js?v=notion-catalog-3",
  "../shared/tennisnote-curriculum-search.js?v=1.0.408",
  "../shared/tennisnote-release.js?v=1.0.408",
  "../shared/tennisnote-release-updater.js?v=1.0.408",
  "../shared/tennisnote-issue-reporter.js?v=issue-reporter-4",
  "../shared/tennisnote-issue-reporter.css?v=issue-reporter-4",
  "../shared/tennisnote-ui-language.js?v=1.0.408",
  "../shared/tennisnote-ticket-state.js?v=1.0.408",
  "../shared/tennisnote-mode-transition.js?v=1.0.408",
  "../shared/tennisnote-comment-draft.js?v=1.0.408",
  "../shared/tennisnote-input-guard.js?v=1.0.408",
  "../shared/tennisnote-ui-foundation.css?v=1.0.408",
];
