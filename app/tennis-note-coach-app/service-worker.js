const CACHE_NAME = "tennis-note-coach-mode-v457";
...
const APP_SHELL = [
  ...
  "./domain/records.js?v=1.0.435",
  "./domain/members.js?v=1.0.435",
  "./domain/schedule-v2.js?v=1.0.435",
  "./domain/notices.js?v=1.0.435",
  "./domain/curriculum.js?v=1.0.435",
  "./domain/settlement.js?v=1.0.435",
  "./domain/makeup.js?v=1.0.435",
  "./domain/shared-data.js?v=1.0.435",
  "./domain/tasks.js?v=1.0.435",
  "./views/home.js?v=1.0.435",
  "./views/schedule.js?v=1.0.435",
  "./views/members.js?v=1.0.435",
  "./views/records.js?v=1.0.435",
  "./views/curriculum.js?v=1.0.435",
  "./views/settlement.js?v=1.0.435",
  ...
  "./data/records.js?v=1.0.435",
  "./ui/sheet.js?v=1.0.435",
  "./ui/screens.js?v=1.0.435",
  "./actions/records.js?v=1.0.435",
  "./actions/schedule.js?v=1.0.435",
  ...
  "../shared/tennisnote-curriculum-search.js?v=1.0.435",
  ...
  "../shared/tennisnote-comment-draft.js?v=1.0.435",
