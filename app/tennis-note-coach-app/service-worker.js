...
const APP_SHELL = [
  ...
  "./domain/records.js?v=1.0.443",
  "./domain/members.js?v=1.0.443",
  "./domain/schedule-v2.js?v=1.0.443",
  "./domain/notices.js?v=1.0.443",
  "./domain/curriculum.js?v=1.0.443",
  "./domain/settlement.js?v=1.0.443",
  "./domain/makeup.js?v=1.0.443",
  "./domain/shared-data.js?v=1.0.443",
  "./domain/tasks.js?v=1.0.443",
  "./views/home.js?v=1.0.443",
  "./views/schedule.js?v=1.0.443",
  "./views/members.js?v=1.0.443",
  "./views/records.js?v=1.0.443",
  "./views/curriculum.js?v=1.0.443",
  "./views/settlement.js?v=1.0.443",
  ...
  "./data/records.js?v=1.0.443",
  "./ui/sheet.js?v=1.0.443",
  "./ui/screens.js?v=1.0.443",
  "./actions/records.js?v=1.0.443",
  "./actions/schedule.js?v=1.0.443",
  ...
  "../shared/tennisnote-curriculum-search.js?v=1.0.443",
  ...
  "../shared/tennisnote-comment-draft.js?v=1.0.443",
