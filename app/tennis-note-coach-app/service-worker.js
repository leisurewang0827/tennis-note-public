const CACHE_NAME = "tennis-note-coach-mode-v511";
...
const APP_SHELL = [
  ...
  "./domain/records.js?v=1.0.493",
  "./domain/members.js?v=1.0.493",
  "./domain/schedule-v2.js?v=1.0.493",
  "./domain/notices.js?v=1.0.493",
  "./domain/curriculum.js?v=1.0.493",
  "./domain/settlement.js?v=1.0.493",
  "./domain/makeup.js?v=1.0.493",
  "./domain/shared-data.js?v=1.0.493",
  "./domain/tasks.js?v=1.0.493",
  "./views/home.js?v=1.0.493",
  "./views/schedule.js?v=1.0.493",
  "./views/members.js?v=1.0.493",
  "./views/records.js?v=1.0.493",
  "./views/curriculum.js?v=1.0.493",
  "./views/settlement.js?v=1.0.493",
  ...
  "../shared/tennisnote-curriculum-search.js?v=1.0.493",
  ...
  "../shared/tennisnote-comment-draft.js?v=1.0.493",
