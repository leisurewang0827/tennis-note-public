...
const APP_SHELL = [
  ...
  "./domain/records.js?v=1.0.445",
  "./domain/members.js?v=1.0.445",
  "./domain/schedule-v2.js?v=1.0.445",
  "./domain/notices.js?v=1.0.445",
  "./domain/curriculum.js?v=1.0.445",
  "./domain/settlement.js?v=1.0.445",
  "./domain/makeup.js?v=1.0.445",
  "./domain/shared-data.js?v=1.0.445",
  "./domain/tasks.js?v=1.0.445",
  "./views/home.js?v=1.0.445",
  "./views/schedule.js?v=1.0.445",
  "./views/members.js?v=1.0.445",
  "./views/records.js?v=1.0.445",
  "./views/curriculum.js?v=1.0.445",
  "./views/settlement.js?v=1.0.445",
  ...
  "./data/records.js?v=1.0.445",
  "./ui/sheet.js?v=1.0.445",
  "./ui/screens.js?v=1.0.445",
  "./actions/records.js?v=1.0.445",
  "./actions/schedule.js?v=1.0.445",
  ...
  "../shared/tennisnote-curriculum-search.js?v=1.0.445",
  ...
  "../shared/tennisnote-comment-draft.js?v=1.0.445",
