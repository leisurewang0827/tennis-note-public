const CACHE_NAME = "tennis-note-coach-mode-v462";
...
const APP_SHELL = [
  ...
  "./domain/records.js?v=1.0.440",
  "./domain/members.js?v=1.0.440",
  "./domain/schedule-v2.js?v=1.0.440",
  "./domain/notices.js?v=1.0.440",
  "./domain/curriculum.js?v=1.0.440",
  "./domain/settlement.js?v=1.0.440",
  "./domain/makeup.js?v=1.0.440",
  "./domain/shared-data.js?v=1.0.440",
  "./domain/tasks.js?v=1.0.440",
  "./views/home.js?v=1.0.440",
  "./views/schedule.js?v=1.0.440",
  "./views/members.js?v=1.0.440",
  "./views/records.js?v=1.0.440",
  "./views/curriculum.js?v=1.0.440",
  "./views/settlement.js?v=1.0.440",
  ...
  "./data/records.js?v=1.0.440",
  "./ui/sheet.js?v=1.0.440",
  "./ui/screens.js?v=1.0.440",
  "./actions/records.js?v=1.0.440",
  "./actions/schedule.js?v=1.0.440",
  ...
  "../shared/tennisnote-curriculum-search.js?v=1.0.440",
  ...
  "../shared/tennisnote-comment-draft.js?v=1.0.440",
