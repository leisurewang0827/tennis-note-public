const CACHE_NAME = "tennis-note-coach-mode-v514";
...
const APP_SHELL = [
  ...
  "./domain/records.js?v=1.0.502",
  "./domain/members.js?v=1.0.502",
  "./domain/schedule-v2.js?v=1.0.502",
  "./domain/notices.js?v=1.0.502",
  "./domain/curriculum.js?v=1.0.502",
  "./domain/settlement.js?v=1.0.502",
  "./domain/makeup.js?v=1.0.502",
  "./domain/shared-data.js?v=1.0.502",
  "./domain/tasks.js?v=1.0.502",
  "./views/home.js?v=1.0.502",
  "./views/schedule.js?v=1.0.502",
  "./views/members.js?v=1.0.502",
  "./views/records.js?v=1.0.502",
  "./views/curriculum.js?v=1.0.502",
  "./views/settlement.js?v=1.0.502",
  ...
  "./data/records.js?v=1.0.502",
  "./ui/sheet.js?v=1.0.502",
  "./ui/screens.js?v=1.0.502",
  "./actions/records.js?v=1.0.502",
  "./actions/schedule.js?v=1.0.502",
  ...
  "../shared/tennisnote-curriculum-search.js?v=1.0.502",
  ...
  "../shared/tennisnote-comment-draft.js?v=1.0.502",
