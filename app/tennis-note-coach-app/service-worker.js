const CACHE_NAME = "tennis-note-coach-mode-v395";
...
const APP_SHELL = [
  ...
  "./domain/records.js?v=1.0.374",
  "./domain/members.js?v=1.0.374",
  "./domain/schedule-v2.js?v=1.0.374",
  "./domain/notices.js?v=1.0.374",
  "./domain/curriculum.js?v=1.0.374",
  "./domain/settlement.js?v=1.0.374",
  "./domain/makeup.js?v=1.0.374",
  "./domain/shared-data.js?v=1.0.374",
  "./domain/tasks.js?v=1.0.374",
  "./views/home.js?v=1.0.374",
  "./views/schedule.js?v=1.0.374",
  "./views/members.js?v=1.0.374",
  "./views/records.js?v=1.0.374",
  "./views/curriculum.js?v=1.0.374",
  "./views/settlement.js?v=1.0.374",
  ...
  "./data/records.js?v=1.0.374",
  "./ui/sheet.js?v=1.0.374",
  "./ui/screens.js?v=1.0.374",
  "./actions/records.js?v=1.0.374",
  "./actions/schedule.js?v=1.0.374",
  ...
  "../shared/tennisnote-curriculum-search.js?v=1.0.374",
  ...
  "../shared/tennisnote-comment-draft.js?v=1.0.374",
