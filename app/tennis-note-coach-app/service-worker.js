...
const APP_SHELL = [
  ...
  "./domain/records.js?v=1.0.472",
  "./domain/members.js?v=1.0.472",
  "./domain/schedule-v2.js?v=1.0.472",
  "./domain/notices.js?v=1.0.472",
  "./domain/curriculum.js?v=1.0.472",
  "./domain/settlement.js?v=1.0.472",
  "./domain/makeup.js?v=1.0.472",
  "./domain/shared-data.js?v=1.0.472",
  "./domain/tasks.js?v=1.0.472",
  "./views/home.js?v=1.0.472",
  "./views/schedule.js?v=1.0.472",
  "./views/members.js?v=1.0.472",
  "./views/records.js?v=1.0.472",
  "./views/curriculum.js?v=1.0.472",
  "./views/settlement.js?v=1.0.472",
  ...
  "./data/records.js?v=1.0.472",
  "./ui/sheet.js?v=1.0.472",
  "./ui/screens.js?v=1.0.472",
  "./actions/records.js?v=1.0.472",
  "./actions/schedule.js?v=1.0.472",
  ...
  "../shared/tennisnote-curriculum-search.js?v=1.0.472",
  ...
  "../shared/tennisnote-comment-draft.js?v=1.0.472",
