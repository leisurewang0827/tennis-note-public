const CACHE_NAME = "tennis-note-coach-mode-v124";
...
const APP_SHELL = [
  ...
  "./app.js?v=1.0.94",
  "./assets/app-icon.svg",
  "../shared/tennisnote-data-client.js?v=1.0.94",
  "../shared/tennisnote-curriculum-catalog.js",
  "../shared/tennisnote-release.js?v=1.0.94",
  "../shared/tennisnote-issue-reporter.js",
  "../shared/tennisnote-issue-reporter.css",
  "../shared/tennisnote-ui-language.js?v=1.0.94",
  "../shared/tennisnote-input-guard.js?v=1.0.94",
  "../shared/tennisnote-ui-foundation.css?v=1.0.94",
];
