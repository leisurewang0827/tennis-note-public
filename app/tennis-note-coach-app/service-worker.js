const CACHE_NAME = "tennis-note-coach-mode-v520";
...
const APP_SHELL = [
  ...
  "./domain/records.js?v=1.0.508",
  "./domain/members.js?v=1.0.508",
  "./domain/schedule-v2.js?v=1.0.508",
  "./domain/notices.js?v=1.0.508",
  "./domain/curriculum.js?v=1.0.508",
  "./domain/settlement.js?v=1.0.508",
  "./domain/makeup.js?v=1.0.508",
  "./domain/shared-data.js?v=1.0.508",
  "./domain/tasks.js?v=1.0.508",
  "./views/home.js?v=1.0.508",
  "./views/schedule.js?v=1.0.508",
  "./views/members.js?v=1.0.508",
  "./views/records.js?v=1.0.508",
  "./views/curriculum.js?v=1.0.508",
  "./views/settlement.js?v=1.0.508",
  ...
  "./data/records.js?v=1.0.508",
  "./ui/sheet.js?v=1.0.508",
  "./ui/screens.js?v=1.0.508",
  "./actions/records.js?v=1.0.508",
  "./actions/schedule.js?v=1.0.508",
  ...
  "../shared/tennisnote-curriculum-search.js?v=1.0.508",
  ...
  "../shared/tennisnote-comment-draft.js?v=1.0.508",
