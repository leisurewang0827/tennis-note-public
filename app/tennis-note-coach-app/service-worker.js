const CACHE_NAME = "tennis-note-coach-mode-v494";
...
const APP_SHELL = [
  ...
  "./domain/records.js?v=1.0.473",
  "./domain/members.js?v=1.0.473",
  "./domain/schedule-v2.js?v=1.0.473",
  "./domain/notices.js?v=1.0.473",
  "./domain/curriculum.js?v=1.0.473",
  "./domain/settlement.js?v=1.0.473",
  "./domain/makeup.js?v=1.0.473",
  "./domain/shared-data.js?v=1.0.473",
  "./domain/tasks.js?v=1.0.473",
  "./views/home.js?v=1.0.473",
  "./views/schedule.js?v=1.0.473",
  "./views/members.js?v=1.0.473",
  "./views/records.js?v=1.0.473",
  "./views/curriculum.js?v=1.0.473",
  "./views/settlement.js?v=1.0.473",
  ...
  "./data/records.js?v=1.0.473",
  "./ui/sheet.js?v=1.0.473",
  "./ui/screens.js?v=1.0.473",
  "./actions/records.js?v=1.0.473",
  "./actions/schedule.js?v=1.0.473",
  ...
  "../shared/tennisnote-curriculum-search.js?v=1.0.473",
  ...
  "../shared/tennisnote-comment-draft.js?v=1.0.473",
