const CACHE_NAME = "tennis-note-coach-mode-v300";
const CACHE_PREFIX = "tennis-note-coach-mode-";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=1.0.281",
  "./app.js?v=1.0.281",
  "./assets/app-icon.svg",
  "../release.json",
  ...
  "../shared/tennisnote-ui-language.js?v=1.0.281",
  "../shared/tennisnote-comment-draft.js?v=1.0.281",
  "../shared/tennisnote-input-guard.js?v=1.0.281",
  "../shared/tennisnote-ui-foundation.css?v=1.0.281",
];
