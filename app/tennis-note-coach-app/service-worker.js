const CACHE_NAME = "tennis-note-coach-mode-v421";
...
const APP_SHELL = [
  ...
  "./domain/records.js?v=1.0.399",
  "./domain/members.js?v=1.0.399",
  "./domain/schedule-v2.js?v=1.0.399",
  "./domain/notices.js?v=1.0.399",
  "./domain/curriculum.js?v=1.0.399",
  "./domain/settlement.js?v=1.0.399",
  "./domain/makeup.js?v=1.0.399",
  "./domain/shared-data.js?v=1.0.399",
  "./domain/tasks.js?v=1.0.399",
  "./views/home.js?v=1.0.399",
  "./views/schedule.js?v=1.0.399",
  "./views/members.js?v=1.0.399",
  "./views/records.js?v=1.0.399",
  "./views/curriculum.js?v=1.0.399",
  "./views/settlement.js?v=1.0.399",
  ...
  "./data/records.js?v=1.0.399",
  "./ui/sheet.js?v=1.0.399",
  "./ui/screens.js?v=1.0.399",
  "./actions/records.js?v=1.0.399",
  "./actions/schedule.js?v=1.0.399",
  ...
  "../shared/tennisnote-curriculum-search.js?v=1.0.399",
  ...
  "../shared/tennisnote-comment-draft.js?v=1.0.399",
