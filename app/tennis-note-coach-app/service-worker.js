const CACHE_NAME = "tennis-note-coach-mode-v501";
...
const APP_SHELL = [
  ...
  "./domain/records.js?v=1.0.481",
  "./domain/members.js?v=1.0.481",
  "./domain/schedule-v2.js?v=1.0.481",
  "./domain/notices.js?v=1.0.481",
  "./domain/curriculum.js?v=1.0.481",
  "./domain/settlement.js?v=1.0.481",
  "./domain/makeup.js?v=1.0.481",
  "./domain/shared-data.js?v=1.0.481",
  "./domain/tasks.js?v=1.0.481",
  "./views/home.js?v=1.0.481",
  "./views/schedule.js?v=1.0.481",
  "./views/members.js?v=1.0.481",
  "./views/records.js?v=1.0.481",
  "./views/curriculum.js?v=1.0.481",
  "./views/settlement.js?v=1.0.481",
  ...
  "../shared/tennisnote-curriculum-search.js?v=1.0.481",
  ...
  "../shared/tennisnote-comment-draft.js?v=1.0.481",
