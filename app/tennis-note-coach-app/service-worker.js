const CACHE_NAME = "tennis-note-coach-mode-v420";
...
const APP_SHELL = [
  ...
  "./domain/records.js?v=1.0.398",
  "./domain/members.js?v=1.0.398",
  "./domain/schedule-v2.js?v=1.0.398",
  "./domain/notices.js?v=1.0.398",
  "./domain/curriculum.js?v=1.0.398",
  "./domain/settlement.js?v=1.0.398",
  "./domain/makeup.js?v=1.0.398",
  "./domain/shared-data.js?v=1.0.398",
  "./domain/tasks.js?v=1.0.398",
  "./views/home.js?v=1.0.398",
  "./views/schedule.js?v=1.0.398",
  "./views/members.js?v=1.0.398",
  "./views/records.js?v=1.0.398",
  "./views/curriculum.js?v=1.0.398",
  "./views/settlement.js?v=1.0.398",
  ...
  "./data/records.js?v=1.0.398",
  "./ui/sheet.js?v=1.0.398",
  "./ui/screens.js?v=1.0.398",
  "./actions/records.js?v=1.0.398",
  "./actions/schedule.js?v=1.0.398",
  ...
  "../shared/tennisnote-curriculum-search.js?v=1.0.398",
  ...
  "../shared/tennisnote-comment-draft.js?v=1.0.398",
