...
const APP_SHELL = [
  ...
  "./domain/records.js?v=1.0.475",
  "./domain/members.js?v=1.0.475",
  "./domain/schedule-v2.js?v=1.0.475",
  "./domain/notices.js?v=1.0.475",
  "./domain/curriculum.js?v=1.0.475",
  "./domain/settlement.js?v=1.0.475",
  "./domain/makeup.js?v=1.0.475",
  "./domain/shared-data.js?v=1.0.475",
  "./domain/tasks.js?v=1.0.475",
  "./views/home.js?v=1.0.475",
  "./views/schedule.js?v=1.0.475",
  "./views/members.js?v=1.0.475",
  "./views/records.js?v=1.0.475",
  "./views/curriculum.js?v=1.0.475",
  "./views/settlement.js?v=1.0.475",
  ...
  "./data/records.js?v=1.0.475",
  "./ui/sheet.js?v=1.0.475",
  "./ui/screens.js?v=1.0.475",
  "./actions/records.js?v=1.0.475",
  "./actions/schedule.js?v=1.0.475",
  ...
  "../shared/tennisnote-curriculum-search.js?v=1.0.475",
  ...
  "../shared/tennisnote-comment-draft.js?v=1.0.475",
