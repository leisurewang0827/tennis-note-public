const CACHE_NAME = "tennis-note-coach-mode-v424";
...
const APP_SHELL = [
  ...
  "./domain/records.js?v=1.0.402",
  "./domain/members.js?v=1.0.402",
  "./domain/schedule-v2.js?v=1.0.402",
  "./domain/notices.js?v=1.0.402",
  "./domain/curriculum.js?v=1.0.402",
  "./domain/settlement.js?v=1.0.402",
  "./domain/makeup.js?v=1.0.402",
  "./domain/shared-data.js?v=1.0.402",
  "./domain/tasks.js?v=1.0.402",
  "./views/home.js?v=1.0.402",
  "./views/schedule.js?v=1.0.402",
  "./views/members.js?v=1.0.402",
  "./views/records.js?v=1.0.402",
  "./views/curriculum.js?v=1.0.402",
  "./views/settlement.js?v=1.0.402",
  ...
  "./data/records.js?v=1.0.402",
  "./ui/sheet.js?v=1.0.402",
  "./ui/screens.js?v=1.0.402",
  "./actions/records.js?v=1.0.402",
  "./actions/schedule.js?v=1.0.402",
  ...
  "../shared/tennisnote-curriculum-search.js?v=1.0.402",
  ...
  "../shared/tennisnote-comment-draft.js?v=1.0.402",
