...
const APP_SHELL = [
  ...
  "./domain/records.js?v=1.0.447",
  "./domain/members.js?v=1.0.447",
  "./domain/schedule-v2.js?v=1.0.447",
  "./domain/notices.js?v=1.0.447",
  "./domain/curriculum.js?v=1.0.447",
  "./domain/settlement.js?v=1.0.447",
  "./domain/makeup.js?v=1.0.447",
  "./domain/shared-data.js?v=1.0.447",
  "./domain/tasks.js?v=1.0.447",
  "./views/home.js?v=1.0.447",
  "./views/schedule.js?v=1.0.447",
  "./views/members.js?v=1.0.447",
  "./views/records.js?v=1.0.447",
  "./views/curriculum.js?v=1.0.447",
  "./views/settlement.js?v=1.0.447",
  ...
  "./data/records.js?v=1.0.447",
  "./ui/sheet.js?v=1.0.447",
  "./ui/screens.js?v=1.0.447",
  "./actions/records.js?v=1.0.447",
  "./actions/schedule.js?v=1.0.447",
  ...
  "../shared/tennisnote-curriculum-search.js?v=1.0.447",
  ...
  "../shared/tennisnote-comment-draft.js?v=1.0.447",
