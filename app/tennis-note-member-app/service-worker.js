const CACHE_NAME = "tennis-note-member-pwa-v533";
...
const APP_SHELL = [
  ...
  "./domain/products.js?v=1.0.486",
  "./domain/identity.js?v=1.0.486",
  "./domain/journal.js?v=1.0.486",
  "./domain/curriculum.js?v=1.0.486",
  "./domain/payment.js?v=1.0.486",
  "./domain/purchase.js?v=1.0.486",
  "./domain/tickets.js?v=1.0.486",
  "./domain/policy.js?v=1.0.486",
  "./domain/lessons.js?v=1.0.486",
  "./domain/changes.js?v=1.0.486",
  ...
  "./domain/onboarding.js?v=1.0.486",
  "./views/home.js?v=1.0.486",
  "./views/schedule.js?v=1.0.486",
  "./views/profile.js?v=1.0.486",
  "./views/tickets.js?v=1.0.486",
  "./views/products.js?v=1.0.486",
  "./views/journal.js?v=1.0.486",
  "./views/curriculum.js?v=1.0.486",
  "./views/requests.js?v=1.0.486",
  "./views/onboarding.js?v=1.0.486",
  "./events/delegated.js?v=1.0.486",
  "./events/account.js?v=1.0.486",
  "./events/makeup.js?v=1.0.486",
  "./events/journal.js?v=1.0.486",
  "./events/profile.js?v=1.0.486",
  "./events/schedule.js?v=1.0.486",
  "./events/home.js?v=1.0.486",
  "./data/auth.js?v=1.0.486",
  "./data/sync.js?v=1.0.486",
  "./data/push.js?v=1.0.486",
  "./data/payment.js?v=1.0.486",
  "./data/journal.js?v=1.0.486",
  "./data/tickets.js?v=1.0.486",
  "./data/onboarding.js?v=1.0.486",
  "./ui/sheet.js?v=1.0.486",
  "./ui/screens.js?v=1.0.486",
  "./storage.js?v=1.0.486",
  "./actions/requests.js?v=1.0.486",
  "./actions/enrollment.js?v=1.0.486",
  "./actions/profile.js?v=1.0.486",
  "./actions/journal.js?v=1.0.486",
  "./actions/payment.js?v=1.0.486",
  "./actions/session.js?v=1.0.486",
  "./actions/onboarding.js?v=1.0.486",
  "./domain/common.js?v=1.0.486",
  "./domain/members.js?v=1.0.486",
  "./views/common.js?v=1.0.486",
  "./forms/common.js?v=1.0.486",
  "./forms/members.js?v=1.0.486",
  "./forms/notices.js?v=1.0.486",
  "./forms/payment.js?v=1.0.486",
  "./forms/schedule.js?v=1.0.486",
  "./forms/tickets.js?v=1.0.486",
