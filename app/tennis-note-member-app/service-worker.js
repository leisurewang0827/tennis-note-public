const CACHE_NAME = "tennis-note-member-pwa-v423";
...
const APP_SHELL = [
  ...
  "./domain/products.js?v=1.0.375",
  "./domain/identity.js?v=1.0.375",
  "./domain/journal.js?v=1.0.375",
  "./domain/curriculum.js?v=1.0.375",
  "./domain/payment.js?v=1.0.375",
  "./domain/purchase.js?v=1.0.375",
  "./domain/tickets.js?v=1.0.375",
  "./domain/policy.js?v=1.0.375",
  "./domain/lessons.js?v=1.0.375",
  "./domain/changes.js?v=1.0.375",
  ...
  "./views/tickets.js?v=1.0.375",
  "./views/products.js?v=1.0.375",
  "./views/journal.js?v=1.0.375",
  "./views/curriculum.js?v=1.0.375",
  "./views/requests.js?v=1.0.375",
  "./events/delegated.js?v=1.0.375",
  "./events/account.js?v=1.0.375",
  "./events/makeup.js?v=1.0.375",
  "./events/journal.js?v=1.0.375",
  "./events/profile.js?v=1.0.375",
  "./events/schedule.js?v=1.0.375",
  "./events/home.js?v=1.0.375",
  "./data/auth.js?v=1.0.375",
  "./data/sync.js?v=1.0.375",
  "./data/push.js?v=1.0.375",
  "./data/payment.js?v=1.0.375",
  "./data/journal.js?v=1.0.375",
  "./ui/sheet.js?v=1.0.375",
  "./ui/screens.js?v=1.0.375",
  "./storage.js?v=1.0.375",
  "./actions/requests.js?v=1.0.375",
  "./actions/enrollment.js?v=1.0.375",
  "./actions/profile.js?v=1.0.375",
  "./actions/journal.js?v=1.0.375",
  "./actions/payment.js?v=1.0.375",
  ...
  "./forms/members.js?v=1.0.375",
  "./forms/notices.js?v=1.0.375",
  "./forms/payment.js?v=1.0.375",
  "./forms/schedule.js?v=1.0.375",
  "./forms/tickets.js?v=1.0.375",
