...
const APP_SHELL = [
  ...
  "./domain/identity.js?v=1.0.371",
  "./domain/journal.js?v=1.0.371",
  "./domain/curriculum.js?v=1.0.371",
  "./domain/payment.js?v=1.0.371",
  "./domain/purchase.js?v=1.0.371",
  "./domain/tickets.js?v=1.0.371",
  "./domain/policy.js?v=1.0.371",
  "./domain/lessons.js?v=1.0.371",
  "./domain/changes.js?v=1.0.371",
  "./domain/schedule.js?v=1.0.371",
  "./domain/coaches.js?v=1.0.371",
  "./domain/shared-data.js?v=1.0.371",
  "./domain/notices.js?v=1.0.371",
  "./domain/values.js?v=1.0.371",
  "./views/home.js?v=1.0.371",
  "./views/schedule.js?v=1.0.371",
  "./views/profile.js?v=1.0.371",
  "./views/tickets.js?v=1.0.371",
  "./views/products.js?v=1.0.371",
  "./views/journal.js?v=1.0.371",
  "./views/curriculum.js?v=1.0.371",
  "./views/requests.js?v=1.0.371",
  "./events/delegated.js?v=1.0.371",
  "./events/account.js?v=1.0.371",
  "./events/makeup.js?v=1.0.371",
  "./events/journal.js?v=1.0.371",
  "./events/profile.js?v=1.0.371",
  "./events/schedule.js?v=1.0.371",
  "./events/home.js?v=1.0.371",
  "./data/auth.js?v=1.0.371",
  "./data/sync.js?v=1.0.371",
  "./data/push.js?v=1.0.371",
  "./data/payment.js?v=1.0.371",
  "./data/journal.js?v=1.0.371",
  "./ui/sheet.js?v=1.0.371",
  "./ui/screens.js?v=1.0.371",
  "./storage.js?v=1.0.371",
  "./actions/requests.js?v=1.0.371",
  "./actions/enrollment.js?v=1.0.371",
  "./actions/profile.js?v=1.0.371",
  "./actions/journal.js?v=1.0.371",
  "./actions/payment.js?v=1.0.371",
  "./actions/session.js?v=1.0.371",
  "./app.js?v=1.0.371",
  ...
  "../shared/tennisnote-release.js?v=1.0.371",
  "../shared/tennisnote-release-updater.js?v=1.0.371",
  "../shared/tennisnote-issue-reporter.js?v=issue-reporter-3",
  "../shared/tennisnote-issue-reporter.css?v=issue-reporter-3",
  "../shared/tennisnote-ui-language.js?v=1.0.371",
  "../shared/tennisnote-ticket-state.js?v=1.0.371",
  "../shared/tennisnote-bottom-sheet.js?v=bottom-sheet-1",
  "../shared/tennisnote-input-guard.js?v=1.0.371",
  "../shared/tennisnote-ui-foundation.css?v=1.0.371",
