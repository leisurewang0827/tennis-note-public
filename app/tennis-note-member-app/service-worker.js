const CACHE_NAME = "tennis-note-member-pwa-v519";
...
const APP_SHELL = [
  ...
  "./domain/products.js?v=1.0.470",
  "./domain/identity.js?v=1.0.470",
  "./domain/journal.js?v=1.0.470",
  "./domain/curriculum.js?v=1.0.470",
  "./domain/payment.js?v=1.0.470",
  "./domain/purchase.js?v=1.0.470",
  "./domain/tickets.js?v=1.0.470",
  "./domain/policy.js?v=1.0.470",
  "./domain/lessons.js?v=1.0.470",
  "./domain/changes.js?v=1.0.470",
  ...
  "./domain/onboarding.js?v=1.0.470",
  "./views/home.js?v=1.0.470",
  "./views/schedule.js?v=1.0.470",
  "./views/profile.js?v=1.0.470",
  "./views/tickets.js?v=1.0.470",
  "./views/products.js?v=1.0.470",
  "./views/journal.js?v=1.0.470",
  "./views/curriculum.js?v=1.0.470",
  "./views/requests.js?v=1.0.470",
  "./views/onboarding.js?v=1.0.470",
  "./events/delegated.js?v=1.0.470",
  "./events/account.js?v=1.0.470",
  "./events/makeup.js?v=1.0.470",
  "./events/journal.js?v=1.0.470",
  "./events/profile.js?v=1.0.470",
  "./events/schedule.js?v=1.0.470",
  "./events/home.js?v=1.0.470",
  "./data/auth.js?v=1.0.470",
  "./data/sync.js?v=1.0.470",
  "./data/push.js?v=1.0.470",
  "./data/payment.js?v=1.0.470",
  "./data/journal.js?v=1.0.470",
  "./data/tickets.js?v=1.0.470",
  "./data/onboarding.js?v=1.0.470",
  "./ui/sheet.js?v=1.0.470",
  "./ui/screens.js?v=1.0.470",
  "./storage.js?v=1.0.470",
  "./actions/requests.js?v=1.0.470",
  "./actions/enrollment.js?v=1.0.470",
  "./actions/profile.js?v=1.0.470",
  "./actions/journal.js?v=1.0.470",
  "./actions/payment.js?v=1.0.470",
  "./actions/session.js?v=1.0.470",
  "./actions/onboarding.js?v=1.0.470",
  "./domain/common.js?v=1.0.470",
  "./domain/members.js?v=1.0.470",
  "./views/common.js?v=1.0.470",
  "./forms/common.js?v=1.0.470",
  "./forms/members.js?v=1.0.470",
  "./forms/notices.js?v=1.0.470",
  "./forms/payment.js?v=1.0.470",
  "./forms/schedule.js?v=1.0.470",
  "./forms/tickets.js?v=1.0.470",
