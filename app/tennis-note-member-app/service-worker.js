const CACHE_NAME = "tennis-note-member-pwa-v505";
...
const APP_SHELL = [
  ...
  "./domain/products.js?v=1.0.456",
  "./domain/identity.js?v=1.0.456",
  "./domain/journal.js?v=1.0.456",
  "./domain/curriculum.js?v=1.0.456",
  "./domain/payment.js?v=1.0.456",
  "./domain/purchase.js?v=1.0.456",
  "./domain/tickets.js?v=1.0.456",
  "./domain/policy.js?v=1.0.456",
  "./domain/lessons.js?v=1.0.456",
  "./domain/changes.js?v=1.0.456",
  ...
  "./domain/onboarding.js?v=1.0.456",
  "./views/home.js?v=1.0.456",
  "./views/schedule.js?v=1.0.456",
  "./views/profile.js?v=1.0.456",
  "./views/tickets.js?v=1.0.456",
  "./views/products.js?v=1.0.456",
  "./views/journal.js?v=1.0.456",
  "./views/curriculum.js?v=1.0.456",
  "./views/requests.js?v=1.0.456",
  "./views/onboarding.js?v=1.0.456",
  "./events/delegated.js?v=1.0.456",
  "./events/account.js?v=1.0.456",
  "./events/makeup.js?v=1.0.456",
  "./events/journal.js?v=1.0.456",
  "./events/profile.js?v=1.0.456",
  "./events/schedule.js?v=1.0.456",
  "./events/home.js?v=1.0.456",
  "./data/auth.js?v=1.0.456",
  "./data/sync.js?v=1.0.456",
  "./data/push.js?v=1.0.456",
  "./data/payment.js?v=1.0.456",
  "./data/journal.js?v=1.0.456",
  "./data/tickets.js?v=1.0.456",
  "./data/onboarding.js?v=1.0.456",
  "./ui/sheet.js?v=1.0.456",
  "./ui/screens.js?v=1.0.456",
  "./storage.js?v=1.0.456",
  "./actions/requests.js?v=1.0.456",
  "./actions/enrollment.js?v=1.0.456",
  "./actions/profile.js?v=1.0.456",
  "./actions/journal.js?v=1.0.456",
  "./actions/payment.js?v=1.0.456",
  "./actions/session.js?v=1.0.456",
  "./actions/onboarding.js?v=1.0.456",
  "./domain/common.js?v=1.0.456",
  "./domain/members.js?v=1.0.456",
  "./views/common.js?v=1.0.456",
  "./forms/common.js?v=1.0.456",
  "./forms/members.js?v=1.0.456",
  "./forms/notices.js?v=1.0.456",
  "./forms/payment.js?v=1.0.456",
  "./forms/schedule.js?v=1.0.456",
  "./forms/tickets.js?v=1.0.456",
