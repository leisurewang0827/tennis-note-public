const CACHE_NAME = "tennis-note-member-pwa-v513";
...
const APP_SHELL = [
  ...
  "./domain/products.js?v=1.0.464",
  "./domain/identity.js?v=1.0.464",
  "./domain/journal.js?v=1.0.464",
  "./domain/curriculum.js?v=1.0.464",
  "./domain/payment.js?v=1.0.464",
  "./domain/purchase.js?v=1.0.464",
  "./domain/tickets.js?v=1.0.464",
  "./domain/policy.js?v=1.0.464",
  "./domain/lessons.js?v=1.0.464",
  "./domain/changes.js?v=1.0.464",
  ...
  "./domain/onboarding.js?v=1.0.464",
  "./views/home.js?v=1.0.464",
  "./views/schedule.js?v=1.0.464",
  "./views/profile.js?v=1.0.464",
  "./views/tickets.js?v=1.0.464",
  "./views/products.js?v=1.0.464",
  "./views/journal.js?v=1.0.464",
  "./views/curriculum.js?v=1.0.464",
  "./views/requests.js?v=1.0.464",
  "./views/onboarding.js?v=1.0.464",
  "./events/delegated.js?v=1.0.464",
  "./events/account.js?v=1.0.464",
  "./events/makeup.js?v=1.0.464",
  "./events/journal.js?v=1.0.464",
  "./events/profile.js?v=1.0.464",
  "./events/schedule.js?v=1.0.464",
  "./events/home.js?v=1.0.464",
  "./data/auth.js?v=1.0.464",
  "./data/sync.js?v=1.0.464",
  "./data/push.js?v=1.0.464",
  "./data/payment.js?v=1.0.464",
  "./data/journal.js?v=1.0.464",
  "./data/tickets.js?v=1.0.464",
  "./data/onboarding.js?v=1.0.464",
  "./ui/sheet.js?v=1.0.464",
  "./ui/screens.js?v=1.0.464",
  "./storage.js?v=1.0.464",
  "./actions/requests.js?v=1.0.464",
  "./actions/enrollment.js?v=1.0.464",
  "./actions/profile.js?v=1.0.464",
  "./actions/journal.js?v=1.0.464",
  "./actions/payment.js?v=1.0.464",
  "./actions/session.js?v=1.0.464",
  "./actions/onboarding.js?v=1.0.464",
  "./domain/common.js?v=1.0.464",
  "./domain/members.js?v=1.0.464",
  "./views/common.js?v=1.0.464",
  "./forms/common.js?v=1.0.464",
  "./forms/members.js?v=1.0.464",
  "./forms/notices.js?v=1.0.464",
  "./forms/payment.js?v=1.0.464",
  "./forms/schedule.js?v=1.0.464",
  "./forms/tickets.js?v=1.0.464",
