...
function registerPwaServiceWorker() {
  ...
  window.addEventListener("load", () => {
    ...
    const refreshKey = "tennis-note-sw-refresh-1.0.114";
    ...
    navigator.serviceWorker.register("./service-worker.js?v=1.0.114", { updateViaCache: "none" })
      .then((registration) => {
...
function openCoachMode() {
  ...
  saveSnapshot();
  const params = new URLSearchParams({ v: "1.0.114" });
