...
function registerPwaServiceWorker() {
  ...
  window.addEventListener("load", () => {
    ...
    const refreshKey = "tennis-note-sw-refresh-1.0.42";
    ...
    navigator.serviceWorker.register("./service-worker.js?v=1.0.42", { updateViaCache: "none" })
      .then((registration) => {
...
function openCoachMode() {
  ...
  saveSnapshot();
  const params = new URLSearchParams({ v: "1.0.42" });
