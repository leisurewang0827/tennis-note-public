...
function registerPwaServiceWorker() {
  window.TennisNoteReleaseUpdater?.start({
    ...
    workerUrl: "./service-worker.js?v=1.0.410",
...
function openCoachMode() {
  ...
  const params = new URLSearchParams({ v: "1.0.410", view: target.view || "todayView" });
...
async function initApp() {
  ...
  window.TennisNoteModeTransition?.warm("../tennis-note-coach-app/index.html?v=1.0.410");
...
window.__TENNIS_NOTE_MEMBER_APP_RUNTIME__ = Object.freeze({
  version: window.TENNIS_NOTE_RELEASE?.version || "1.0.410",
