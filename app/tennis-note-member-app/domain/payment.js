...
function paymentServerErrorMessage(error) {
  ...
  const labels = {
    ...
    bank_transfer_confirmation_in_progress: "입금과 회원권을 서버에서 처리 중입니다. 잠시 후 결제 내역을 다시 확인해 주세요.",
    bank_transfer_amount_mismatch: "신청 금액과 입금 확인 금액이 다릅니다. 관리자에게 확인해 주세요.",
    bank_transfer_deposit_late_confirmation_required: "입금기한이 지나 관리자 확인이 필요합니다.",
